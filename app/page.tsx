							...
							<Card className="bg-white/80 backdrop-blur w-full">
								...
								<CardContent>
									<p className="text-gray-700 leading-relaxed text-sm sm:text-base">
										30 अगस्त 2024 को एक मासिक न्यूज लैटर की शुरुआत इस उद्देश्य से की गई कि इसमें उत्तराखंड से जुड़े शोध-पत्र, उभरती प्रतिभाओं
										की कला, पहाड़ के व्यंजन और पर्यटन के साथ-साथ उत्तराखंड की समृद्ध विरासत और संस्कृति को भी समुचित स्थान मिले।
									</p>
								</CardContent>
							</Card>
						</div>
